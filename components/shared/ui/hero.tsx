...
export default function HeroSection({ data }: HeroSectionProps) {
    const words = data.titleHighlight === "Leaders"
    ...
    return (
        <section
            className="relative w-full h-[calc(100vh-5rem)] min-h-[600px] flex items-center justify-center text-center overflow-hidden"
            style={{
